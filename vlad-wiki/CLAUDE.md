# Vlad's NeuroSpect Wiki

Personal working wiki for Vlad. Obsidian vault for research-in-progress, daily notes, and working documents.
...
- Absolute paths for references to `wiki/`, `paul-wiki/`, or code
